...
import br.com.desafio.common.application.configuration.settings.DWRSettings;
import br.com.desafio.common.application.dwr.DwrAnnotationPostProcessor;
...
public class CommonWebConfiguration extends WebMvcConfigurerAdapter
{
	...
	public DwrAnnotationPostProcessor dwrAnnotationPostProcessor( ApplicationContext applicationContext )
	{
		...
		scanner.scan( "br.com.desafio.*.domain" );
