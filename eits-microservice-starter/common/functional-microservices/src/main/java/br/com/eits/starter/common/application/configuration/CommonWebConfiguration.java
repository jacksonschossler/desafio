...
import br.com.eits.starter.common.application.configuration.settings.DWRSettings;
import br.com.eits.starter.common.application.dwr.DwrAnnotationPostProcessor;
...
public class CommonWebConfiguration extends WebMvcConfigurerAdapter
{
	...
	public DwrAnnotationPostProcessor dwrAnnotationPostProcessor( ApplicationContext applicationContext )
	{
		...
		scanner.scan( "br.com.eits.starter.*.domain" );
